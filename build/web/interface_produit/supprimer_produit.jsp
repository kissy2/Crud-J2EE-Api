...
<html>
    ...
    <body>
        ...
        <hr>
               ...
               <form action="http://localhost:8080/Examen_Tp_Aymen/Servlet_Supprimer_Produit" method="post">
     <label for="id">ID&nbsp;&nbsp;&nbsp;&nbsp;</label><input min="0" type="number" id="id" name="id"  placeholder="Veullez entrer : l'id du produit à supprimer " required >&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="submit" value="Supprimer Produit">&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Annuler">
    </form>
        <br>
