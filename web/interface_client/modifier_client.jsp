...
%>          
<form action="http://localhost:8080/Examen_Tp_Aymen/Servlet_Modifier_Client" method="post">
...
<table>
                ...
                <tr><td colspan="2" ><input type="submit" value="Modifer Client">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Annuler"></td></tr>
